...
var imageNum= 0;
    ...
    OnlineImage.prototype = {
        ...
        pushData: function (list) {
            ...
            /* 拿缩略图参数  */
            var imageOnlineCompress = editor.getOpt('imageOnlineCompress');
            /* 正文图片的缩略图规则  */
            var imageCompressForMobile = editor.getOpt('imageCompressForMobile');
            ...
            for (i = 0; i < list.length; i++) {
                ...
                var delid='imagelist_'+imageNum+'_auto_'+i;
                ...
                if(list[i] && list[i].url) {
                    ...
                    /* 判断 如果是以缩略图参数imageOnlineCompress结尾 就截掉这个结尾 */
                    tempsrc = urlPrefix + (list[i].url.indexOf(imageOnlineCompress) == -1?list[i].url:list[i].url.substr(0,list[i].url.indexOf(imageOnlineCompress)));
                    tempsrc+=imageCompressForMobile;
                    img.setAttribute('_src',tempsrc );
