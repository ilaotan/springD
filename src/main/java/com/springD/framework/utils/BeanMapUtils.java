...
public final class BeanMapUtils {  
    ...
    /**
     * Converts a JavaBean to another JavaBean
     * @throws InstantiationException  
     */
    public static final Object BeantoBean(Class<?> type,Object bean)  
    throws IntrospectionException, IllegalAccessException, InvocationTargetException, InstantiationException {  
    	 ...
    	 return MaptoBean(type, map);
	}  
    /**
     * Converts a JavaBean to another Array
     * @throws InstantiationException  
     */
    public static final Object[] BeantoArray(Object bean)  
	    throws IntrospectionException, IllegalAccessException, InvocationTargetException {  
		BeanInfo beanInfo = Introspector.getBeanInfo(bean.getClass());  
		PropertyDescriptor[] propertyDescriptors = beanInfo.getPropertyDescriptors();
		...
		for (int i = 0; i< propertyDescriptors.length; i++) {  
		    ...
		    if (!propertyName.equals("class")) {  
		        Method readMethod = descriptor.getReadMethod();  
		        Object result = readMethod.invoke(bean, new Object[0]);  
		        returnMap.add(result);
		    }  
		}  
		return returnMap.toArray();  
		}  
}  